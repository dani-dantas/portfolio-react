    ...
    <section id="projetos">
        <div id="projetosContainer">
            ...
            <div id="projetosCards">
                <div className="card">
                    <h2>Aprendendo Spring</h2>
                    <p>API REST desenvolvida com Java e Spring Boot para gerenciamento de usuários, com autenticação, integração com PostgreSQL e segurança baseada em JWT. Demonstra conhecimentos em desenvolvimento back-end, organização em camadas e integração entre aplicação e banco de dados.</p>
                    <a className="button githubBtn" href="https://github.com/dani-dantas/aprendendo-spring" target="_blank">
